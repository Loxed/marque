 ...
 * Built-in Directives
 * ===================
 * All out-of-the-box directives are defined here.
 * To add a new directive, call defineDirective() — no changes needed anywhere else.
 *
 * Inline directives  → @name           (no @end)
 * Block directives   → @name … @end name
 */
